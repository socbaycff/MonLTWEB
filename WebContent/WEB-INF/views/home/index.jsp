				...
				<div class="item">
					...
					<div class="item-content">
						...
						<div class="main-content">
							...
							<a href="job-details.html"><h4>Bán cá.</h4></a>
				...
				<div class="item">
					...
					<div class="item-content">
						...
						<div class="main-content">
							...
							<a href="job-details.html"><h4>Lau kính.</h4></a>
				...
				<div class="item">
					...
					<div class="item-content">
						...
						<div class="main-content">
							...
							<a href="job-details.html"><h4>Cave.</h4></a>
				...
				<div class="item">
					...
					<div class="item-content">
						...
						<div class="main-content">
							...
							<a href="job-details.html"><h4>Lorem ipsum dolor sit
									amet.</h4></a>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<span>$60 000</span> <a href="jobs.htmll"><h4>Lorem
										ipsum dolor sit amet, consectetur</h4></a>
								<p>Nullam nibh mi, tincidunt sed sapien ut, rutrum hendrerit
									velit. Integer auctor a mauris sit amet eleifend.</p>
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<div class="down-content">
								<span>$60 000</span> <a href="jobs.html"><h4>Lorem
										ipsum dolor sit amet, consectetur</h4></a>
								<p>Nullam nibh mi, tincidunt sed sapien ut, rutrum hendrerit
									velit. Integer auctor a mauris sit amet eleifend.</p>
								<div class="post-options">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="main-content">
						<div class="row">
							<div class="col-lg-8">
								<span>Vì tương lai sáng cmn lạng.</span>
								<h4>Hãy đến với chúng toi, cùng nhau making money.</h4>
							</div>
							<div class="col-lg-4">
