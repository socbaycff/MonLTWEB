	...
	<div class="main-banner header-text">
		<div class="container-fluid">
			<div class="owl-banner owl-carousel">
				...
				<c:forEach var="job" items="${newJobs}">

						<!-- <div class="col-md-4 col-sm-6">
							<div class="blog-post">
								<div class="blog-thumb">
									<img width="300" height="300" src="uploads/${job.jobId}" alt="">
								</div>
								<div class="down-content">
									<span>${job.luong} VND</span> <a href="job-details/${job.jobId}.html">
										<h4>${job.title}</h4>
									</a>
									<p>${job.description}</p>
						...
						<div class="item">
							<img width="400" height="400" src="uploads/${job.jobId}" alt="">
							<div class="item-content">
		
								<div class="main-content">
									<div class="meta-category">
										<span>${job.luong} VND</span>
									</div>
		
									<a href="job-details/${job.jobId}.html">
										<h4>${job.title}</h4>
									</a>
	...
	<section class="blog-posts grid-system">
		<div class="container">
			<div class="all-blog-posts">
				...
				<br>
				<div class="row">
					<c:forEach var="job" items="${randomJobs}">
